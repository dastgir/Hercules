...
//       some script commands should be revised as well...
	long long int class_base[3]; ///< Specifies if the base can wear this item (split in 3 indexes per type: 1-1, 2-1, 2-2)
...
struct itemdb_interface {
	...
	void (*jobmask2mapid) (long long int *bclass, long long int jobmask);
	void (*jobid2mapid) (long long int *bclass, int job_id, bool enable);
